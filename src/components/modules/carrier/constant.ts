...
export const CarrierField = {
  ...
  PASSWORD: "password",
  PHONE: "phone",
  PHONE_SAFETY_SUPPORT: "phone_safety_support",
  PHONE_ACCOUNTING: "phone_accounting",
  PHONE_FLEET_MANAGER: "phone_flee_manager",
  PHONE_ELD_SUPPRORT: "phone_eld_support",
  PHONE_OVERSIZE_PERMITS: "phone_oversize_permits",
